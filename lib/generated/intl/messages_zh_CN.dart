...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "manage_table_subtitle":
            MessageLookupByLibrary.simpleMessage("添加、删除课表，或检查课表更新"),
        "manage_table_title": MessageLookupByLibrary.simpleMessage("课表管理"),
        "month": MessageLookupByLibrary.simpleMessage("月"),
        "more_settings_subtitle":
            MessageLookupByLibrary.simpleMessage("颜色、背景与课表显示选项"),
        "more_settings_title": MessageLookupByLibrary.simpleMessage("更多设置"),
        ...
        "white_title_mode_subtitle":
            MessageLookupByLibrary.simpleMessage("背景图片较暗时开启，让标题文字更清晰"),
